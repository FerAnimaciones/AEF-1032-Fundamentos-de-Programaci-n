//class Musica.java
   ...
   public class Musica
   {
      ...
      public void leer()
      {
         nombre_puesto[n]=showInputDialog("Nombre del la banda:");
         capacidad[n]=Integer.parseInt(showInputDialog("Miembors"));
         n++;
      }
      public void mostrar()
      {
