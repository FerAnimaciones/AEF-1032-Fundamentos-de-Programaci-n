 ...
 *****************************************************************************************/  
   ...
   { 
      ...
      public void leer()
      {
         ...
         this.a=new float [tam][tam2];
         for(int i=0;i<tam;i++)
         {
            for(int e=0;e<tam2;e++)
            {
               a[i][e]=Float.parseFloat(showInputDialog(null,"Ingrese el numero del renglon #"+(i+1)+" en la columna"+(e+1)+" :"));
            }
         }
      }
      public void mostrar()
