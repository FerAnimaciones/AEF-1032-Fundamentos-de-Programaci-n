   ...
   public class Hojas
   {
      ...
      public static void EJERCICIO1_13()
      {
      ...
      public static void EJERCICIO2_7()
      {
      ...
      public static void EJERCICIO2_8()
      {
         int a,b;
      ...
      public static void EJERCICIO2_9() 
      {  
      ...
      public static void EJERCICIO2_10()
      {
      ...
      public static void EJERCICIO2_20(){
      ...
      public static void EJERCICIO2_21(){
      ...
      public static void EJERCICIO3_10()//3.10
      {
         double p=1;
         String cad="";
      ...
      public static void EJERCICIO3_13()//3.13
      {
      ...
      public void EJERCICIO_3_41()
      {
         int anox=0,carry_y=0;
         int alum[][]=new int [10][5];
      }
   	
      public void EJERCICIO_3_42()
      {
         int x=0,n=00,k=0;
         Random r = new Random();
         int limite=2;     
      ...
      public void EJERCICIO_3_44()
      {
         ...
         if(n>0)
         {
            ...
            if(i<n)
            {
               ...
               while((p2+1)<=n && p1>=p2)
               {
                  showMessageDialog(null,"P1= "+p1+" P2="+p2+" I="+i);                  p1=p1-1;                  p2=p2+1;
               }
               i=i+1;
            }
         }
      ...
      public static void main(String ar[])
      {
         ...
         llamar.EJERCICIO1_8();      
         llamar.EJERCICIO1_9();      
         llamar.EJERCICIO1_10();      
         llamar.Distancia();      
         llamar.EJERCICIO1_12();      
         llamar.EJERCICIO1_13();      
         llamar.EJERCICIO2_1();      
         llamar.EJERCICIO2_2();      
         llamar.EJERCICIO2_9();      
         llamar.Serie();      
         llamar.EJERCICIO3_10();      
         llamar.EJERCICIO3_13();      
         llamar.EJERCICIO3_20();      
         llamar.EJERCICIO3_30();      
         llamar.EJERCICIO_3_42();      
         llamar.EJERCICIO_3_43();      
         llamar.EJERCICIO_3_44();      
         Numperfect();     
         llamar.sumaDeNum();      
      }
   }